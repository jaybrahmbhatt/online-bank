...
function loadAtm(map) {
    ...
    var lat = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 37.3;
    var lng = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : -121.8;
}
